...
//                Elements pElements = e.getAllElements();
//                for (Element hE : pElements) {
//                    if (hE.tagName().equals("p")) {
//                        s.append(hE.ownText());
//
//                    }
//                    if (hE.tagName().equals("frame")) {
//                        model.setArticleVideoSourceUrl(hE.attr("src"));
//
//                    }
//                }
//            }
            model.setSourceUrl(page.getHtml().links().all().toString());
//            model.setArticleContent(s.toString());
//            model.setDescription(s.toString().split("\\.")[0]);
//            if (model.getArticleVideoSourceUrl()==null) {
//                page.setSkip(true);
//            }
